...
<head>
    ...
    <title>Alter ● {{ $page_name ?? 'Yeni Ürün' }}</title>
    ...
    <div class="admin-dashboard">
        ...
        <section class="dashboard">
            ...
            <div class="dash-content interactive-tab" id="p-1">
                <form action="/product_control/new_product/add" method="POST" enctype="multipart/form-data">
                    @csrf
                <div class="product-control-grid grid-dashboard-title" data-title="Yeni ürün ekle">
                        ...
                        <div class="control">
                            <div class="product-left">
                                    ...
                                    <div class="product-update">
                                        <input class="product-input" type="submit" value="Ekle">
                                    </div>
                            </div>
