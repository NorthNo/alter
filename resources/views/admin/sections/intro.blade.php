    ...
    <div class="admin-dashboard">
        ...
        <section class="dashboard">
            ...
            <div class="dash-content interactive-tab">
                <form method="POST" action="/section/add/intro">
                    @csrf
                    <div class="grid-dashboard-half grid-dashboard-title" data-title="Giriş bölümü">
                        <a class="item">
                            <input type="text" placeholder="Title" value="{{ $giris['title'] ?? '' }}" name="title">
                            <textarea name="content" id="" placeholder="Content">{{ $giris['content'] ?? '' }}</textarea>
                        </a>
                        <a class="item">
                            <div class="formbold-form-wrapper">
                                    <div class="formbold-file-input">
                                        ...
                                        <label for="file">
                                            <div>
                                                <span class="formbold-drop-file"> Dosya Sürükle</span>
