...
<body>
    <div class="admin-dashboard">
        ...
        <section class="dashboard">
            ...
            <div class="dash-content interactive-tab" id="s-2">
                <form method="POST" action="/section/add/mps">
                    @csrf
                    <div class="grid-dashboard-full grid-dashboard-title" data-title="En çok tercih edilenler">
                        <a class="item">
                            <input type="text" placeholder="Title" value="{{ $ms['title'] ?? '' }}" name="title">
                            <textarea name="content" id="" placeholder="Açıklama">{{ $ms['content'] ?? '' }}</textarea>
                        </a>
                    </div>
                    <div class="grid-dashboard-full">
                        <button class="upgrade-button" type="submit">Güncelle</button>
                    </div>
                </form>
            </div>
        </section>
